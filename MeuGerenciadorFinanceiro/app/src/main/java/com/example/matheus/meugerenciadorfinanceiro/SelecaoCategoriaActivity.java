...
public class SelecaoCategoriaActivity extends ListActivity {

    public static final String EXTRA_CAT = "categoria";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String categoria = getIntent().getStringExtra(EXTRA_CAT);
        if (categoria != null) {
